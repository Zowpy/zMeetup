package me.zowpy.meetup.utils.menu.pagination;

import lombok.Getter;
import me.zowpy.meetup.utils.menu.Menu;
import me.zowpy.meetup.utils.menu.buttons.Button;
import me.zowpy.meetup.utils.menu.pagination.button.PageButton;
...
public abstract class PaginatedMenu extends Menu {
    ...
    public String getTitle(Player player) {
        return ChatColor.translateAlternateColorCodes('&', getPrePaginatedTitle(player) + "  &8[" + page + "/" + getPages(player)+ "]");
    }
